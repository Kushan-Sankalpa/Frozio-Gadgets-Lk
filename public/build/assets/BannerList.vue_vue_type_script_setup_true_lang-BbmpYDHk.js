import{D as p}from"./Datatable-C0N7iYPg.js";import{d as h,c as f,b as t,j as v,s as x,p as _,P as s,h as g,C as l,i as w}from"./app-C24KS1Xk.js";const y={class:"rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm"},C=h({__name:"BannerList",setup(k){const i=_(()=>s("homebanners.data")),d=g(0),c=[{data:"id",name:"id"},{data:"name",name:"name"},{data:"video_url",name:"video_path",orderable:!1,searchable:!1},{data:"description",name:"description"},{data:"actions",name:"actions",orderable:!1,searchable:!1}],u=[{targets:2,render:e=>e?`
        <video
          src="${e}"
          muted
          playsinline
