import{D as p}from"./Datatable-CCMSMu0X.js";import{d as f,c as h,a as t,b as v,h as x,f as g,P as s,e as _,g as l,m as w}from"./app-WeRKTPas.js";const y={class:"rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm"},C=f({__name:"BannerList",setup(k){const i=g(()=>s("homebanners.data")),d=_(0),c=[{data:"id",name:"id"},{data:"name",name:"name"},{data:"video_url",name:"video_path",orderable:!1,searchable:!1},{data:"description",name:"description"},{data:"actions",name:"actions",orderable:!1,searchable:!1}],u=[{targets:2,render:e=>e?`
        <video
          src="${e}"
          muted
          playsinline
