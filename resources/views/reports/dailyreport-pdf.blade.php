...
<head>
    ...
    <style>
        ...
        /* Dompdf font: use absolute local path */
        @font-face {
        ...
        * { box-sizing: border-box; }
        ...
        /* ✅ Same style as Appointment Summary PDF (NOT cards) */
        .summary-table {
            width: 100%;
...
<body>
    <div class="report-header">
        <div class="header-left">
            ...
            <h1 class="report-title">Daily sale report (Sales with Team)</h1>
        </div>
    ...
    @php
        $dateLabel = $filters['date'] ?? now()->format('Y-m-d');
    ...
    <div class="meta-block">
        <div class="meta-row">
            <span class="meta-label">Date:</span> {{ $dateLabel }}
        </div>
    ...
    <!-- ✅ Totals as rows (like your screenshot) -->
    ...
    <table class="table">
        ...
        @empty
            <tr>
                <td colspan="4" class="text-center">No sales found for this date.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
