...
<template>
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2 lg:gap-0 bg-black text-white relative overflow-hidden">
        ...
        <section
            class="relative z-10 order-2 lg:order-1 flex items-center justify-end px-4 sm:px-6 lg:px-8 py-10 lg:py-0">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <Input id="email" type="email" name="email" required autofocus autocomplete="email"
                                    placeholder="email@example.com" :tabindex="1"
  ...
  <div class="mb-2 flex items-center justify-between">
    ...
    <TextLink v-if="canResetPassword" :href="request()" class="text-sm text-white">
      Forgot password?
    </TextLink>
  </div>
  ...
  <InputError :message="errors.password" />
                        ...
                        <div class="flex items-center justify-between">
                            <label for="remember"
                                class="flex cursor-pointer select-none items-center gap-3 text-base text-white">
                                <Checkbox id="remember" name="remember" :tabindex="3" />
                                <span>Remember me</span>
                            </label>
                            <!-- <span class="text-sm text-white">Secure login</span> -->
                        </div>
                ...
                <div class="h-2 w-full rounded-b-2xl bg-gradient-to-r from-transparent via-[#FF2000]/40 to-transparent">
                </div>
            </div>
        </section>

        <section
            class="relative z-10 order-1 lg:order-2 flex items-center justify-start px-4 sm:px-6 lg:px-8 py-10 lg:py-0">
            <div class="relative flex w-full max-w-3xl flex-col items-center justify-center mb-6 lg:mb-0">
                ...
                <img src="/assets/images/baber_romove_bg.png" alt="Drift Barber"
...
.animate-slideUpSoft {
    animation: slideUpSoft .7s cubic-bezier(.22, .61, .36, 1) both;
}
