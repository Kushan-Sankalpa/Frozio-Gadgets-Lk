import{D as p}from"./Datatable-BS0zvdrb.js";import{d as h,c as f,b as t,j as v,s as x,p as _,P as s,h as g,y as l,i as y}from"./app-Xu6JF1Af.js";const w={class:"rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm"},C=h({__name:"BannerList",setup(k){const i=_(()=>s("homebanners.data")),d=g(0),c=[{data:"id",name:"id"},{data:"name",name:"name"},{data:"video_url",name:"video_path",orderable:!1,searchable:!1},{data:"description",name:"description"},{data:"actions",name:"actions",orderable:!1,searchable:!1}],u=[{targets:2,render:e=>e?`
        <video
          src="${e}"
          muted
          playsinline
