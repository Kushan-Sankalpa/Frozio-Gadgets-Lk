import{D as p}from"./Datatable-BGf118ns.js";import{d as h,c as f,a as t,b as g,h as _,f as x,P as o,e as v,g as d,m as k}from"./app-BE7nq0c7.js";const w={class:"rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm"},C=h({__name:"BannerList",setup(B){const i=x(()=>o("homebanners.data")),l=v(0),c=[{data:"id",name:"id"},{data:"name",name:"name"},{data:"desktop_image_url",name:"desktop_image_path",orderable:!1,searchable:!1},{data:"mobile_image_url",name:"mobile_image_path",orderable:!1,searchable:!1},{data:"description",name:"description"},{data:"actions",name:"actions",orderable:!1,searchable:!1}],m=[{targets:2,render:e=>e?`
        <img
          src="${e}"
          alt="Desktop Banner"
